...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch('/admin/get-sampah-by-jenis/' + jenisID)
                ...
                .then(data => {
                    ...
                    data.forEach(item => {
                        ...
                        opt.textContent = item.nama_sampah + ' - Rp' + parseInt(item.harga_per_kg).toLocaleString('id-ID') + '/kg';
        ...
        modalSetoran.addEventListener('hidden.bs.modal', function() {
            ...
            document.querySelector('.subtotal') && (document.querySelector('.subtotal').dataset.nilai = 0);
        ...
        document.getElementById('btn-simpan').addEventListener('click', function(e) {
            ...
            if (!nasabahSelect.value) {
                Swal.fire({ icon: 'warning', title: 'Pilih nasabah terlebih dahulu' });
                return;
            }
