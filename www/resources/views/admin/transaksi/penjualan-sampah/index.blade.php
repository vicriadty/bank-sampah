...
@section('content')
    ...
    {{-- Form Filter --}}
    <form id="formFilterPenjualan" method="GET" action="{{ route('admin.penjualan.index') }}" class="row gy-2 mb-3">
        <div class="col-md-4">
            <input type="text" name="pengepul" class="form-control" placeholder="Cari Kode atau Nama Pengepul..."
    ...
    <div class="modal fade" id="voidModalPenjualan" tabindex="-1" aria-labelledby="voidModalPenjualanLabel"
        aria-hidden="true">
                ...
                <form action="" method="POST" id="formVoidPenjualan">
                    ...
                    <div class="modal-body">
                        <p>Apakah Anda yakin ingin membatalkan transaksi penjualan atas nama pengepul <strong
                                id="pengepulNamePenjualan"></strong>?</p>
                        <div class="mb-3">
                            <label for="alasan_batal_penjualan" class="form-label">Alasan Pembatalan <span
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('modalPenjualan').addEventListener('hidden.bs.modal', function() {
                ...
                if (firstRow) {
                    ...
                    firstRow.querySelector('.subtotal') && (firstRow.querySelector('.subtotal').dataset
                        .nilai = 0);
                    firstRow.querySelector('.harga-per-kg') && (firstRow.querySelector('.harga-per-kg')
                        .value = '');
